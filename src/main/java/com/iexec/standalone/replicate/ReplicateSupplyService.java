...
import com.iexec.standalone.chain.Web3jService;
import com.iexec.standalone.contribution.ConsensusHelper;
...
import com.iexec.standalone.replicate.ReplicateTaskSummary.ReplicateTaskSummaryBuilder;
...
public class ReplicateSupplyService implements Purgeable {
    ...
    private TaskNotificationExtra getTaskNotificationExtra(Task task, TaskNotificationType taskNotificationType, String walletAddress) {
        ...
        final TaskNotificationExtra.TaskNotificationExtraBuilder taskNotificationExtra = TaskNotificationExtra.builder()
                .workerpoolAuthorization(authorization);
